...
class NewReturnProducerPage extends StatefulWidget {
  const NewReturnProducerPage({Key? key}) : super(key: key);

  @override
  State<NewReturnProducerPage> createState() => _NewReturnProducerPageState();
}

class _NewReturnProducerPageState extends State<NewReturnProducerPage> {
  String createdTime = '';
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const Text("Новый документ возврата поставщику",
