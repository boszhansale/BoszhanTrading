...
class DiscountCardProductsPage extends StatefulWidget {
  const DiscountCardProductsPage({Key? key, required this.order})
      : super(key: key);

  final DiscountCardOrderModel order;

  @override
  State<DiscountCardProductsPage> createState() =>
      _DiscountCardProductsPageState();
}

class _DiscountCardProductsPageState extends State<DiscountCardProductsPage> {
  @override
  void initState() {
    checkLogin();
    super.initState();
