...
class IncomingOrderHistoryProductsPage extends StatefulWidget {
  const IncomingOrderHistoryProductsPage({Key? key, required this.order})
      : super(key: key);

  final IncomingOrderHistoryModel order;

  @override
  State<IncomingOrderHistoryProductsPage> createState() =>
      _IncomingOrderHistoryProductsPageState();
}

class _IncomingOrderHistoryProductsPageState
    extends State<IncomingOrderHistoryProductsPage> {
  @override
  void initState() {
    checkLogin();
    super.initState();
