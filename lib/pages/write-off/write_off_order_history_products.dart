...
class WriteOffOrderHistoryProductsPage extends StatefulWidget {
  const WriteOffOrderHistoryProductsPage({Key? key, required this.order})
      : super(key: key);

  final WriteOffOrderHistoryModel order;

  @override
  State<WriteOffOrderHistoryProductsPage> createState() =>
      _WriteOffOrderHistoryProductsPageState();
}

class _WriteOffOrderHistoryProductsPageState
    extends State<WriteOffOrderHistoryProductsPage> {
  @override
  void initState() {
    checkLogin();
    super.initState();
