...
class XReportPage extends StatefulWidget {
  const XReportPage({
    Key? key,
  }) : super(key: key);

  @override
  State<XReportPage> createState() => _XReportPageState();
}

class _XReportPageState extends State<XReportPage> {
            ...
            report.taxPayerVATSeria != null
                ? Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(width: 1, color: ColorPalette.black)),
                    child: Column(
                      children: [
                        ...
                        Text(
                          '${report.startOn} - ${report.reportOn}',
                          style: ProjectStyles.textStyle_10Medium,
                        ),
                        const Text(
  ...
  void _init() async {
    try {
      var response = await MainApiService().requestXReport();
