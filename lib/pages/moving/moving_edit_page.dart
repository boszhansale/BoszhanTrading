...
class MovingEditPage extends StatefulWidget {
  const MovingEditPage({Key? key, required this.order}) : super(key: key);

  final MovingOrderHistoryModel order;

  @override
  State<MovingEditPage> createState() => _MovingEditPageState();
}

class _MovingEditPageState extends State<MovingEditPage> {
  String name = '';
  String storeName = '';
  String storageName = '';
  ...
  void saveChanges() async {
    ...
    try {
      var response = await MainApiService().editMovingOrder(
        widget.order.id,
        sendBasketList,
      );
      print(response);
