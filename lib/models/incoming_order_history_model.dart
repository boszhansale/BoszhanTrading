...
class IncomingOrderHistoryModel {
  final int id;
  ...
  factory IncomingOrderHistoryModel.fromJson(Map<String, dynamic> json) {
    return IncomingOrderHistoryModel(
      id: json['id'],
